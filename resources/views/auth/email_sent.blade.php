{{-- C:\laragon\www\dashboard-livewire\resources\views\auth\email_sent.blade.php --}}
<x-layouts.guest title="E-mail Enviado! - {{ env('APP_NAME') }}">
    <div
    ...
    <div class="relative flex min-h-screen w-full flex-col bg-gray-50 dark:bg-gray-950 overflow-x-hidden">
                    ...
                    <div class="flex flex-col gap-8 w-full max-w-md mx-auto text-center">
                        ...
                        <div class="flex justify-center">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                ...
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M21.75 6.75v10.5a2.25 2.25 0 0 1-2.25 2.25H4.5a2.25 2.25 0 0 1-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0 0 19.5 4.5H4.5A2.25 2.25 0 0 0 2.25 6.75m19.5 0v.243a2.25 2.25 0 0 1-1.07 1.916l-7.5 4.5a2.25 2.25 0 0 1-2.28 0l-7.5-4.5a2.25 2.25 0 0 1-1.07-1.916V6.75" />
                            </svg>
                        </div>

                        <p class="text-3xl font-black">Verifique seu e-mail</p>

                        <p class="text-base leading-normal">
                            {{ $name }}, enviamos um link de confirmação para o seu e-mail <strong>{{ $email }}</strong>.<br>
